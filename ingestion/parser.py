...
class ChunkBuilder:
    ...
    def build_chunks(self, chapter_number: int, paragraphs: list[ParsedParagraph], starting_chunk_num: int = 1) -> list[ParsedChunk]:
        chunks = []
...
class ChapterExtractor:
    ...
    def extract_chapter(self, item: epub.EpubHtml, chapter_number: int) -> ParsedChapter:
...
class EpubParser:
    ...
    def parse(self, epub_path: Path) -> list[ParsedChapter]:
        ...
        for item_id, linear in book.spine:
            ...
            parsed_chapter = self.chapter_extractor.extract_chapter(item, chapter_number)
