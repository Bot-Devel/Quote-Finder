...
logger.add("quote-finder-maintenance.log", rotation="10 MB", retention="5 days", level="INFO")
...
class LazyEmbeddingProvider:
    ...
    async def embed_documents(self, texts, progress_callback=None):
        return await self.provider.embed_documents(texts, progress_callback=progress_callback)
