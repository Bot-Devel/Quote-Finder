...
async def main():
    ...
    reranker = AsyncRerankerProvider(LocalFastEmbedReranker("jinaai/jina-reranker-v1-tiny-en"), executor)
    ...
    async with session_maker() as session:
        ...
        res = await service.search_semantic(fic.id, fic.active_version_id, "Regulus destroying the horcrux", limit=3)
