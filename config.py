...
INGESTION_MAX_EPUB_BYTES = int(os.getenv("INGESTION_MAX_EPUB_BYTES", "262144000")) # 250 MB
INGESTION_MAX_EXTRACTED_BYTES = int(os.getenv("INGESTION_MAX_EXTRACTED_BYTES", "1073741824")) # 1 GB
INGESTION_CONCURRENCY = int(os.getenv("INGESTION_CONCURRENCY", "1"))
INGESTION_KEEP_FAILED_DATA = os.getenv("INGESTION_KEEP_FAILED_DATA", "false").lower() == "true"
